...
export function ClientDetails() {
    ...
    function tracebleDelivery() {
        return Boolean(clientSelected.traceableDelivery) ? 'Yes' : 'No'
    }
        ...
        <SafeAreaView style={styles.safeArea}>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.header}>
                    ...
                    <Text style={styles.itemsCenter}>{client?.lastname}, {client?.firstname}</Text>
                </View>
                <View style={styles.header}>
                    <View style={styles.itemsCenter}></View>
                    <DeleteButton
                ...
                <ScrollView>
                    ...
                    />
                    <LabelAndValue
                        label='Delivery WeekDays'
                        value={weekDaysLabels()}
                    />
                    <LabelAndValue
