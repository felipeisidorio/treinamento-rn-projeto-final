...
export function ClientForm() {
    ...
    const [contactPreferenceValue, setContactPreferenceValue] = useState<string>('');
    const [openContactPreferenceList, setOpenContactPreferenceList] = useState(false);
    ...
    function getClientDetails() {
        if (clientSelected.id.trim().length > 0) {
            ...
            setValue('deliveryStartTime', new Date(clientSelected.deliveryStartTime || ''))
            setValue('deliveryEndTime', new Date(clientSelected.deliveryEndTime || ''))
        ...
        <SafeAreaView style={styles.safeArea}>
            ...
            <ScrollView>
                ...
                <View style={styles.container}>
                    ...
                    >
                        <Text
                            style={[styles.textButton, styles.textButtonSave]}
                        >
                            Save
                        </Text>
                    ...
                    >
                        <Text
                            style={[styles.textButton, styles.textButtonCancel]}
                        >
                            Cancel
                        </Text>
                    </TouchableOpacity>
